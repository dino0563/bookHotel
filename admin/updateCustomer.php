...
//menangkap data dari id pelanggan
...
if (isset($_POST['submit'])) {
    ...
    $query = "UPDATE pelanggan SET nama = '$nama', alamat = '$alamat', no_telp = '$no_telp', jenis_kelamin = '$jenis_kelamin',  username = '$username', password = '$password'  WHERE id_pelanggan = '$id_pelanggan'";
            ...
            <div id="layoutSidenav_content">
                <main>
                    ...
                    <div class="card mt-3">
                        <div class="card-body">
                            <?php 
                             $query = oci_parse($koneksi,"SELECT * FROM pelanggan WHERE id_pelanggan = $id_pelanggan");
                             oci_execute($query);
                        ...
                        <form action="" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="alamat" class="form-control" id="exampleInputPassword1" value="<?= $data['ALAMAT']; ?>" required>
                            </div>
                            <div class="mb-3">
                                <label for="exampleInputPassword1" class="form-label">No. Telepon</label>
                                <input type="number" name="no_telp" class="form-control" id="exampleInputPassword1" value="<?= $data['NO_TELP']; ?>"  required>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="username" class="form-control" id="exampleInputPassword1" value="<?= $data['USERNAME']; ?>"  required>
                            </div>
                            <div class="mb-3">
                                <label for="exampleInputPassword1" class="form-label">Password</label>
                                <input type="text" name="password" class="form-control" id="exampleInputPassword1" value="<?= $data['PASSWORD']; ?>"  required>
                            </div>
