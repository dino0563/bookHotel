            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Daftar Customer</h1>
                        ...
                        ?>
                            <tr>
                                <th class="text-center"><?php echo $data["ID_PELANGGAN"] ?></th>
                                ...
                                <td class="text-center">
                                    <a class="btn btn-warning" href="updateCustomer.php?id_pelanggan=<?= $data['ID_PELANGGAN']; ?>">Update</a> | <a class="btn btn-danger" href="hapusCustomer.php?id_pelanggan=<?= $data['ID_PELANGGAN']; ?>">Delete</a>
                                </td>
                            </tr>
                            <?php 
                             endwhile; 
