...
if (isset($_POST['submit'])) {
    ...
    $query = "INSERT INTO pelanggan (nama,alamat,no_telp,jenis_kelamin,status,username,password) 
    VALUES('$nama','$alamat','$no_telp','$jenis_kelamin','$status','$username','$password')";
                                ...
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-body">
                                        <form action="" method="post">
                                            ...
                                            <div class="form-floating mb-3">
                                                <input class="form-control" name="status" id="status" type="text" readonly value="admin" />
                                            ...
                                            <div class="mt-4 mb-0">
                                                <div class="d-grid"><button class="btn btn-primary btn-block" href="adminLogin.php" name="submit" type="submit">Create Account</button></div>
                                            </div>
                                        </form>
                                    </div>
                                    <div class="card-footer text-center py-3">
                                        <div class="small"><a href="adminLogin.php">Have an account? Go to login</a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
