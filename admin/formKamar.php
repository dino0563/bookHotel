...
if (isset($_POST['submit'])) {
    ...
    $query = "INSERT INTO kamar (no_kamar,tipe_kamar,harga_kamar) 
    VALUES($no_kamar,'$tipe_kamar',$harga)";
                    ...
                    <div class="card mt-3">
                        ...
                        <form action="" method="POST">
                            <div class="mb-3">
                                ...
                                <input type="number" name="no_kamar" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                            </div>
                            <div class="mb-3">
